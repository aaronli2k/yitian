...
public class PricesPanel extends JPanel {
	...
	//private final Contract m_contract_AUDUSD = new Contract("AUD", "CASH", "IDEALPRO", "USD");
	//private final Contract m_contract_AUDNZD = new Contract("AUD", "CASH", "IDEALPRO", "NZD");
	//private final Contract m_contract_AUDJPY = new Contract("AUD", "CASH", "IDEALPRO", "JPY");
	...
	PricesPanel() {
		...
		add( m_requestPanel, BorderLayout.EAST);
		add( m_resultsPanel, BorderLayout.WEST);
	}
...
//			m_topResultPanel.m_model.addRow( m_contract_AUDUSD);
	//		m_topResultPanel.m_model.addRow( m_contract_AUDNZD);
		//	m_topResultPanel.m_model.addRow( m_contract_AUDJPY);
		}
	}
